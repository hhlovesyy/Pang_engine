...
### （3）导入Obj格式文件的包：Assimp

相关的配置这个包到项目里所需要的：https://www.cnblogs.com/woden3702/p/16478885.html

> 说实话可以直接用NuGet来进行配置，如下图所示：
>
> ![image-20240801162135484](./assets/image-20240801162135484.png)
